...
class TestTokenGeneration:
    ...
    def test_get_token_returns_none_without_secret(self):
    ...
    def test_get_token_refreshes_on_expiry(self):
        from manor.mcp_auth import MCPTokenProvider
...
class TestAuthHeaders:
    ...
    def test_get_auth_headers_returns_empty_dict_without_secret(self):
        from manor.mcp_auth import get_auth_headers
...
class TestIsEnabled:
    ...
    def test_is_enabled_returns_true_when_secret_configured(self):
...
class TestThreadSafety:
    ...
    def test_concurrent_get_token_works(self):
        from manor.mcp_auth import get_token
...
class TestJWTValidation:
    ...
    def test_server_can_validate_token(self):
        from manor.mcp_auth import get_token
...
class TestNeverRaises:
    ...
    def test_get_token_returns_none_when_jwt_encode_fails(self):
        from manor.mcp_auth import get_token
        from manor.mcp_auth.token import MCPTokenProvider
    ...
    def test_get_auth_headers_returns_empty_on_any_error(self):
        from manor.mcp_auth import get_auth_headers
        from manor.mcp_auth.token import MCPTokenProvider
    ...
    def test_is_enabled_returns_false_on_any_error(self):
        ...
        with mock.patch.object(
            MCPTokenProvider, "get_instance", side_effect=Exception("Unexpected")
        ):
            result = is_enabled()
            assert result is False
